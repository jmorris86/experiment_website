...
function displayResults () {
    if (roundNum<10) {
        vendorAReview.innerHTML = 
            `${vendor1.reviewAvg.toFixed(2)} <img src="./assets/images/star.svg" height="15" alt="">`;
        vendorBReview.innerHTML = 
            `${vendor2.reviewAvg.toFixed(2)} <img src="./assets/images/star.svg" height="15" alt="">`;
        vendorCReview.innerHTML = 
            `${vendor3.reviewAvg.toFixed(2)} <img src="./assets/images/star.svg" height="15" alt="">`;
        roundNum +=1;
...
function roundSummary(vendor) {
    ...
    if (vendor === 1) {
        ...
        avgScore = (purchaserA.payoffVendor1 / purchaserA.chosenVendor1).toFixed(2);
        vendor = "A";
    } else if (vendor === 2) {
        reviewScore = vendor2.reviews[roundNum - 1];
        avgScore = (purchaserA.payoffVendor2 / purchaserA.chosenVendor2).toFixed(2);
        vendor = "B";
    } else {
        reviewScore = vendor3.reviews[roundNum - 1];
        avgScore = (purchaserA.payoffVendor3 / purchaserA.chosenVendor3).toFixed(2);
        vendor = "C";
    }
    let message = `
